%Title  :   LaTeX template for creating rough drafts of manuscripts
...
%This will display labels on the pdf
...
%Define commands for highlighting text
\newcommand{\tc}[1]{\textcolor{red}{#1}}
\newcommand{\cites}[1]{ REF #1 FER}
